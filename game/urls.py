...
urlpatterns = [
    ...
    path('personaje/<int:pk>/editar/', views.PersonajeUpdateView.as_view(), name='personaje_edit'),
    ...
    path('enemigo/<int:pk>/editar/', views.EnemigoUpdateView.as_view(), name='enemigo_edit'),
